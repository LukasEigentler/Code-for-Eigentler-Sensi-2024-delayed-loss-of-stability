function b = importhomoclinic_klausmeier(filename, startRow, endRow)
...
%
% Example:
%   b = importfile('b.homoclinic', 1, 5242);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2023/05/23 16:28:49
...
formatSpec = '%4s%*6*s%*4*s%*5s%19s%*19s%19s%[^\n\r]';
